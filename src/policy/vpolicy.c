...
static int parse_policy_table(int argc, char *argv[], int index, struct policy_entry *policy);

static int parse_address(char *arg, struct policy_entry *policy, int type);
static int parse_protocol(char *arg, struct policy_entry *policy);
static int parse_port(char *arg, struct policy_entry *policy, int type);
static int parse_action(char *arg, struct policy_entry *policy);
static int parse_link_select(char *arg, struct policy_entry *policy);
